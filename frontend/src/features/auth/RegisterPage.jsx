...
import { getAuthErrorMessage, registerWithBackend } from "./authService";
  ...
  return (
    <main className="grid min-h-screen place-items-center bg-canvas px-4">
      <form onSubmit={handleSubmit} className="w-full max-w-md rounded-lg border border-line bg-surface p-8 shadow-soft">
        ...
        <p className="mt-3 text-sm text-slate-400">Your account is created through the FastAPI backend and stored in MongoDB.</p>
        {error && (
